...
```
[Install the Stripe CLI](https://stripe.com/docs/billing/subscriptions/fixed-price) - complete all steps under Section 1: Install Stripe Libraries and Tools, including logging in.
```
